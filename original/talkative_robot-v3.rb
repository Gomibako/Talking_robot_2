...
class TalkativeRobot
  ...
  def ask_if_mind_initial
    ...
    @user.instance_args[:name] = @user.instance_args[:initial] if @user.ask_initial_ok?
  end
  ...
  def print_author_info
    ...
    author_info = @people.select {|person| person.is_a?(Author)}
  ...
  def turn_on
    ...
    @people << add_author_info if author_exists?
    @user = nil                if author_exists?
